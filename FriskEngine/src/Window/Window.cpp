...
namespace Frisk::Graphics
{
    ...
    bool Window::ShouldClose() const { return !m_Running; }
    ...
    void Window::ClearColorBufferBit() const { glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT); }

    const std::vector<Event> &Window::GetEventQueue() const { return m_EventQueue; }
