...
namespace Frisk
{
    ...
    OpenGLvertexBuffer::~OpenGLvertexBuffer() { glDeleteBuffers(1, &m_VertexBufferID); }

    void OpenGLvertexBuffer::Bind() const { glBindBuffer(GL_ARRAY_BUFFER, m_VertexBufferID); }
    ...
    void OpenGLvertexBuffer::SetLayout(const VertexBufferLayout &a_Layout) { m_Layout = a_Layout; }
    ...
    U32 OpenGLindexBuffer::GetIndexCount() const { return m_IndexCount; }
